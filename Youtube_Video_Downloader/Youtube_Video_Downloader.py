...
def Widgets():
    head_label = Label(root, text="YouTube Music Downloader", padx=15, pady=15, font="Trebuchet", bg="white", fg="red")
    head_label.grid(row=1, column=1, pady=10, padx=5, columnspan=3)
    link_label = Label(root, text="       Link :      ", bg="lightblue", pady=5, padx=9)
    ...
    destination_label = Label(root, text="Destination :",bg="lightblue",pady=5,padx=9)
    ...
    browse_B = Button(root, text="Browse", command=Browse, width=10, bg="salmon", relief=GROOVE)
    browse_B.grid(row=3, column=2, pady=1, padx=1)
    Download_B = Button(root, text="Download Song", command=Download, width=10, bg="thistle1", pady=10, padx=15, relief=GROOVE, font="Georgia, 13")
